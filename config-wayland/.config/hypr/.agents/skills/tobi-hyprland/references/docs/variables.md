...
URL Source: https://wiki.hypr.land/Configuring/Variables/
...
[![Image 1: Hyprland Wiki](https://wiki.hypr.land/favicon.svg)![Image 2: Hyprland Wiki](https://wiki.hypr.land/favicon-dark.svg)Hyprland Wiki](https://wiki.hypr.land/)[Latest git](https://wiki.hypr.land/version-selector)[Home](https://hypr.land/ "Home")[Showcase](https://hypr.land/hall_of_fame "Showcase")[News](https://hypr.land/news "News")

CTRL K

[GitHub](https://github.com/hyprwm/Hyprland "GitHub")

CTRL K

*   [Version selector ⚙️](https://wiki.hypr.land/version-selector/)
...
*   [Configuring](https://wiki.hypr.land/Configuring/)
    ...
    *   [Start](https://wiki.hypr.land/Configuring/Start/)
    *   [Variables](https://wiki.hypr.land/Configuring/Variables/)
        *   [Variable types](https://wiki.hypr.land/Configuring/Variables/#variable-types)
        *   [Sections](https://wiki.hypr.land/Configuring/Variables/#sections)
    ...
    *   [Tearing](https://wiki.hypr.land/Configuring/Tearing/)
    *   [Dwindle Layout](https://wiki.hypr.land/Configuring/Dwindle-Layout/)
    *   [Master Layout](https://wiki.hypr.land/Configuring/Master-Layout/)
    *   [Permissions](https://wiki.hypr.land/Configuring/Permissions/)
    *   [Using hyprctl](https://wiki.hypr.land/Configuring/Using-hyprctl/)
    *   [Expanding functionality](https://wiki.hypr.land/Configuring/Expanding-functionality/)
    *   [XWayland](https://wiki.hypr.land/Configuring/XWayland/)
    *   [Environment variables](https://wiki.hypr.land/Configuring/Environment-variables/)
    *   [Multi-GPU](https://wiki.hypr.land/Configuring/Multi-GPU/)
    *   [Uncommon tips & tricks](https://wiki.hypr.land/Configuring/Uncommon-tips--tricks/)
...
*   [Hypr Ecosystem](https://wiki.hypr.land/Hypr-Ecosystem/)
    ...
    *   [hyprsysteminfo](https://wiki.hypr.land/Hypr-Ecosystem/hyprsysteminfo/)
    ...
    *   [hyprtoolkit](https://wiki.hypr.land/Hypr-Ecosystem/hyprtoolkit/)
        ...
        *   [Development](https://wiki.hypr.land/Hypr-Ecosystem/hyprtoolkit/development/)

    *   [hyprcursor](https://wiki.hypr.land/Hypr-Ecosystem/hyprcursor/)
    *   [hyprutils](https://wiki.hypr.land/Hypr-Ecosystem/hyprutils/)
    *   [hyprlang](https://wiki.hypr.land/Hypr-Ecosystem/hyprlang/)
    *   [hyprwayland-scanner](https://wiki.hypr.land/Hypr-Ecosystem/hyprwayland-scanner/)
    *   [aquamarine](https://wiki.hypr.land/Hypr-Ecosystem/aquamarine/)
    *   [hyprgraphics](https://wiki.hypr.land/Hypr-Ecosystem/hyprgraphics/)
...
*   [Useful Utilities](https://wiki.hypr.land/Useful-Utilities/)
    ...
    *   [Hypr Ecosystem](https://wiki.hypr.land/Useful-Utilities/Hypr-Ecosystem/)
...
*   [Plugins](https://wiki.hypr.land/Plugins/)
    ...
    *   [Development](https://wiki.hypr.land/Plugins/Development/)
        ...
        *   [Getting started](https://wiki.hypr.land/Plugins/Development/Getting-Started/)
        *   [Plugin guidelines](https://wiki.hypr.land/Plugins/Development/Plugin-Guidelines/)
        *   [Event list](https://wiki.hypr.land/Plugins/Development/Event-list/)
        *   [Advanced](https://wiki.hypr.land/Plugins/Development/Advanced/)
...
*   [Nix](https://wiki.hypr.land/Nix/)
    ...
    *   [Cachix](https://wiki.hypr.land/Nix/Cachix/)
    *   [Hyprland on Other Distros](https://wiki.hypr.land/Nix/Hyprland-on-other-distros/)
    *   [Options & Overrides](https://wiki.hypr.land/Nix/Options-Overrides/)
    *   [Plugins](https://wiki.hypr.land/Nix/Plugins/)
    *   [Contributing and Debugging](https://wiki.hypr.land/Nix/Contributing-and-Debugging/)

*   [NVidia](https://wiki.hypr.land/Nvidia/)
*   [IPC](https://wiki.hypr.land/IPC/)
*   [Crashes and Bugs](https://wiki.hypr.land/Crashes-and-Bugs/)
*   [FAQ](https://wiki.hypr.land/FAQ/)
*   [Connect](https://wiki.hypr.land/Connect/)
...
*   [Snap](https://wiki.hypr.land/Configuring/Variables/#snap)
*   [Decoration](https://wiki.hypr.land/Configuring/Variables/#decoration)
*   [Blur](https://wiki.hypr.land/Configuring/Variables/#blur)
*   [Shadow](https://wiki.hypr.land/Configuring/Variables/#shadow)
*   [Animations](https://wiki.hypr.land/Configuring/Variables/#animations)
*   [Input](https://wiki.hypr.land/Configuring/Variables/#input)
*   [accel_profile](https://wiki.hypr.land/Configuring/Variables/#accel_profile)
*   [scroll_points](https://wiki.hypr.land/Configuring/Variables/#scroll_points)
*   [Touchpad](https://wiki.hypr.land/Configuring/Variables/#touchpad)
*   [Touchdevice](https://wiki.hypr.land/Configuring/Variables/#touchdevice)
*   [Virtualkeyboard](https://wiki.hypr.land/Configuring/Variables/#virtualkeyboard)
*   [Tablet](https://wiki.hypr.land/Configuring/Variables/#tablet)
*   [Per-device input config](https://wiki.hypr.land/Configuring/Variables/#per-device-input-config)
*   [Gestures](https://wiki.hypr.land/Configuring/Variables/#gestures)
*   [Group](https://wiki.hypr.land/Configuring/Variables/#group)
*   [Groupbar](https://wiki.hypr.land/Configuring/Variables/#groupbar)
*   [Misc](https://wiki.hypr.land/Configuring/Variables/#misc)
*   [Binds](https://wiki.hypr.land/Configuring/Variables/#binds)
*   [XWayland](https://wiki.hypr.land/Configuring/Variables/#xwayland)
*   [OpenGL](https://wiki.hypr.land/Configuring/Variables/#opengl)
*   [Render](https://wiki.hypr.land/Configuring/Variables/#render)
*   [Cursor](https://wiki.hypr.land/Configuring/Variables/#cursor)
*   [Ecosystem](https://wiki.hypr.land/Configuring/Variables/#ecosystem)
*   [Experimental](https://wiki.hypr.land/Configuring/Variables/#experimental)
*   [Debug](https://wiki.hypr.land/Configuring/Variables/#debug)
*   [More](https://wiki.hypr.land/Configuring/Variables/#more)

[Edit this page on GitHub →](https://github.com/hyprwm/hyprland-wiki/edit/main/content/Configuring/Variables.md)Scroll to top
...
| allow_tearing | master switch for allowing tearing to occur. See [the Tearing page](https://wiki.hypr.land/Configuring/Tearing). | bool | false |
...
_[More about Animations](https://wiki.hypr.land/Configuring/Animations)._
...
| scroll_factor | Multiplier added to scroll movement for external mice. Note that there is a separate setting for [touchpad scroll_factor](https://wiki.hypr.land/Configuring/Variables/#touchpad). | float | 1.0 |
...
For switchable keyboard configurations, take a look at [the uncommon tips & tricks page entry](https://wiki.hypr.land/Configuring/Uncommon-tips--tricks/#switchable-keyboard-layouts).
...
| name | description | type | default |
| --- | --- | --- | --- |
| auto_group | whether new windows will be automatically grouped into the focused unlocked group. Note: if you want to disable auto_group only for specific windows, use [the “group barred” window rule](https://wiki.hypr.land/Configuring/Window-Rules/#group-window-rule-options) instead. | bool | true |
...
| render_unfocused_fps | the maximum limit for renderunfocused windows’ fps in the background (see also [Window-Rules](https://wiki.hypr.land/Configuring/Window-Rules/#dynamic-rules) - `renderunfocused`) | int | 15 |
...
| workspace_back_and_forth | If enabled, an attempt to switch to the currently focused workspace will instead switch to the previous workspace. Akin to i3’s _auto\_back\_and\_forth_. | bool | false |
...
| create_abstract_socket | Create the [abstract Unix domain socket](https://wiki.hypr.land/Configuring/XWayland/#abstract-unix-domain-socket) for XWayland connections. (XWayland restart is required for changes to take effect; Linux only) | bool | false |
...
| enforce_permissions | whether to enable [permission control](https://wiki.hypr.land/Configuring/Permissions). | bool | false |
...
Requires a client with `frog-color-management-v1` or `xx-color-management-v4` support like gamescope or [https://github.com/Zamundaaa/VK_hdr_layer](https://github.com/Zamundaaa/VK_hdr_layer)
